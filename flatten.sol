...
abstract contract EIP712 {
    ...
    function _domainSeparatorV4() internal view returns (bytes32) {
        if (
            address(this) == _CACHED_THIS && getChainID() == _CACHED_CHAIN_ID
        ) {
...
// File contracts/interfaces/IERC721CollectionFactory.sol
...
// File contracts/collection/ERC721CollectionManager.sol
...
contract ERC721CollectionManager is Ownable, NativeMetaTransaction {
    ...
    */
    function manageCollection(IForwarder _forwarder, IERC721Collection _collection, bytes calldata _data) external {
